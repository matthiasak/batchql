...
var selectionArgsFn = parsers_1.sequence(parsers_1.ignore(/\(/), parsers_1.readN(1, parsers_1.sequence(name, parsers_1.ignore(':'), filterArg, parsers_1.maybe(parsers_1.ignore(',')))), parsers_1.ignore(/\)/));
